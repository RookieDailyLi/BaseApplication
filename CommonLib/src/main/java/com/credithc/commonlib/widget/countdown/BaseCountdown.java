package com.credithc.commonlib.widget.countdown;
...
//        if (!isShowMinute && !isShowSecond) isShowSecond = true;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (isShowMinute) {
            // draw minute text
            canvas.drawText(Utils.formatSecond(mMinute, mHour), mMinuteLeft + mTimeTextWidth / 2, mTimeTextBaseline, mTimeTextPaint);
