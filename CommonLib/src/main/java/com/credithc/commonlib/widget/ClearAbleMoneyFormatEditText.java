...
/**
 * Created by lwj on 2019/3/13.
 * lwjfork@gmail.com
 */
public class ClearAbleMoneyFormatEditText extends MoneyFormatEditText implements View.OnFocusChangeListener, TextWatcher {

    // EditText右侧的删除按钮
    private Drawable mClearDrawable;
    public boolean hasFoucs;
    private ArrayList<View.OnFocusChangeListener> onFocusChangeListeners = new ArrayList<>();

    public ClearAbleMoneyFormatEditText(Context context) {
        this(context, null);
    }

    public ClearAbleMoneyFormatEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public ClearAbleMoneyFormatEditText(Context context, AttributeSet attrs, int defStyle) {
...
//            NoPasteOrCopyEditText.this.clearFocus();
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        for (View.OnFocusChangeListener onFocusChangeListener : onFocusChangeListeners) {
